...
{% include image_tag.html url="/AdBOOST/images/banners/ControlElements.png" alt="Control Elements" style="" %}
...
If you have not created any AdBOOST's Google display campaign yet, please follow the instructions in [Google Display Campaigns guide](/AdBOOST{% post_url 2017-02-01-google-display-campaigns %}). Otherwise, you can deliver your banner ads to your customers in GDN in following three steps:
...
{% include image_tag.html url="/AdBOOST/images/banners/SuitableCampaign.png" alt="Suitable Campaign" style="" %}
...
{% include image_tag.html url="/AdBOOST/images/banners/CampaignBannerAssign.png" alt="Campaign Banner Assign" style="" %}
...
{% include image_tag.html url="/AdBOOST/images/banners/BannerUTM.png" alt="Banner UTM" style="" %}
...
{% include image_tag.html url="/AdBOOST/images/banners/EditorAssetsDownload.png" alt="Editor Assets Download" style="" %}

In every row of banner set listing, under Actions > Assets download

{% include image_tag.html url="/AdBOOST/images/banners/ListingAssetsDownload.png" alt="Listing Assets Download" style="" %}
...
{% include image_tag.html url="/AdBOOST/images/banners/AssetsDownloadModal.png" alt="Assets Download Modal" style="" %}
