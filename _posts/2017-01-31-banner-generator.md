...
Only pre-requisity of automated banners setup is to have at least one active data feed in AdBOOST. If you do not have one yet, please follow our [Feed setup guide]({{site.baseurl}}{% post_url 2017-02-01-feed-setup %})
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/LeftMenuBanners.png" alt="Left Menu Banners" style="height:200px;" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BannersGuidedSetup.png" alt="Banners Guided Setup" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BannersListing.png" alt="Banners Listing" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BannersEmptyForm.png" alt="Banners Empty Form" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BannerTemplateGuidedSetup.png" alt="Banner Template Guided Setup" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BannerEditor.png" alt="Banner Editor" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/TextLayer.png" alt="Text Layer" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/VariablesSuggestion.png" alt="Variables Suggestion" style="" %}

Every element of options pane has a tooltip, that will tell you what action it does (regardless of layer's type)

{% include image_tag.html url="{{site.baseurl}}/images/banners/Tooltips.png" alt="Tooltips" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/FontSelection.png" alt="Font Selection" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/ImageLayer.png" alt="Image Layer" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/FillFrame.png" alt="Fill Frame" style="" %}

**Fit to frame image option**

{% include image_tag.html url="{{site.baseurl}}/images/banners/FitToFrame.png" alt="Fit To Frame" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BatchPreview.png" alt="Batch Preview" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/ControlElements.png" alt="Control Elements" style="" %}
...
If you have not created any AdBOOST's Google display campaign yet, please follow the instructions in [Google Display Campaigns guide]({{site.baseurl}}{% post_url 2017-02-01-google-display-campaigns %}). Otherwise, you can deliver your banner ads to your customers in GDN in following three steps:
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/SuitableCampaign.png" alt="Suitable Campaign" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/CampaignBannerAssign.png" alt="Campaign Banner Assign" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/BannerUTM.png" alt="Banner UTM" style="" %}

### Use them as product images in Facebook export

Follow the instruction in [Feed Export guide]({{site.baseurl}}{% post_url 2017-01-30-feed-exports %}#automated-banners-as-product-images)
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/EditorAssetsDownload.png" alt="Editor Assets Download" style="" %}

In every row of banner set listing, under Actions > Assets download

{% include image_tag.html url="{{site.baseurl}}/images/banners/ListingAssetsDownload.png" alt="Listing Assets Download" style="" %}
...
{% include image_tag.html url="{{site.baseurl}}/images/banners/AssetsDownloadModal.png" alt="Assets Download Modal" style="" %}
