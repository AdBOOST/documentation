...
{% include image_tag.html url="/docs/images/exports/LeftMenuExport.png" alt="Left Menu Export" style="height:200px;" %}
...
{% include image_tag.html url="/docs/images/exports/ExportGuidedSetup.png" alt="Export Guided Setup" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportListing.png" alt="Export Listing" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportEmptyForm.png" alt="Export Empty Form" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportFormProgress.png" alt="Export Form Progress" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportStaticFieldValid.png" alt="Export Static Field Valid" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportCategoryMappingNotSelected.png" alt="Export Category Mapping Not Selected" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportCategoryMapping.png" alt="Export Category Mapping" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportCategoryMappingActive.png" alt="Export Category Mapping Active" style="" %}
...
{% include image_tag.html url="/docs/images/exports/FacebookBannerMapping.png" alt="Facebook Banner Mapping" style="" %}

If you want to assign banner template as a product image and you see dialog below, it means you do not have any banners that are suitable for Facebook advertising network or you have not yet created any banner template at all. In this case follow our [Banner generator guide](/docs{% post_url 2017-01-31-banner-generator %}) to create some.

{% include image_tag.html url="/docs/images/exports/FacebookNoBanners.png" alt="Facebook No Banners" style="" %}
...
{% include image_tag.html url="/docs/images/exports/FacebookBannersModal.png" alt="Facebook Banners Modal" style="" %}
...
{% include image_tag.html url="/docs/images/exports/FacebookBannerAssignActive.png" alt="Facebook Banners Assign Active" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportSubmitBtns.png" alt="Export Submit Buttons" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportStatusLabel.png" alt="Export Status Label" style="" %}

Status label is an indicator of export health and can have following states:

{% include image_tag.html url="/docs/images/StatusLabelStates.png" alt="Status Label States" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportProcessingLog.png" alt="Export Processing Log" style="" %}
...
On the screen below, you can see sample rules (rules are described in detail in [AdBOOST rules guide](/docs{% post_url 2017-02-01-adboost-rules %})) that filter 746 of 1 581 items in feed.

{% include image_tag.html url="/docs/images/exports/ExportItemFiltering.png" alt="Export Item Filtering" style="" %}
...
{% include image_tag.html url="/docs/images/FilterRulesCategoryPreview.png" alt="Filter Rules Category Preview" style="" %}
...
{% include image_tag.html url="/docs/images/FilteredItemsPreview.png" alt="Filtered Items Preview" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportBidding1.png" alt="Export Bidding 1" style="" %}

- Sell out stock quickly to free your warehouse space for fresh (seasonal) merchandise

{% include image_tag.html url="/docs/images/exports/ExportBidding2.png" alt="Export Bidding 2" style="" %}
...
{% include image_tag.html url="/docs/images/exports/ExportBidding3.png" alt="Export Bidding 3" style="" %}
