...
{% include image_tag.html url="/docs/images/rules/FilterRule.png" alt="Filter Rule" style="" %}
...
{% include image_tag.html url="/docs/images/rules/ModifierRules.png" alt="Modifier Rules" style="" %}
...
{% include image_tag.html url="/docs/images/rules/RulesVariableRewrite.png" alt="Rules Variable Rewrite" style="" %}
...
{% include image_tag.html url="/docs/images/rules/RuleOperand.png" alt="Rule Operand" style="" %}

- **OPERATOR** - set of operations that differ for numeric and generic feed properties

{% include image_tag.html url="/docs/images/rules/RuleOperators.png" alt="Rule Operators" style="" %}
...
- **VALUE** - **case-insensitive** text value that differs with operator because there are three types of them:
    ...
    {% include image_tag.html url="/docs/images/rules/BasicOperator.png" alt="Basic Operator" style="" %}

    - **Batch operators** - Contains any, Does not contain any

    {% include image_tag.html url="/docs/images/rules/BatchOperator.png" alt="Batch Operator" style="" %}
